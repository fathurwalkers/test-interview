                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <form action="<?= base_url('/produk/post-tambah-produk'); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>

                                <div class="form-group">
                                    <label for="exampleInputEmail1"><span style="color:red;">* </span>Nama Toko : </label>
                                    <input type="text" class="form-control" placeholder="Masukkan Nama Toko... " name="nama_produk" required autofocus>
